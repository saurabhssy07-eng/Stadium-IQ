...
export const AnalyticsWidget: React.FC = () => {
  ...
  const kpis = computeMissionKpis(incidents);
  ...
  return (
    <div className={styles.kpiContainer}>
      ...
      <div className={styles.kpiTile}>
        ...
        <span className={styles.kpiTileValue}>{kpis.avgResponseSeconds}s</span>
      </div>
      <div className={styles.kpiTile}>
        <span className={styles.kpiTileLabel}>AI Accuracy</span>
        <span className={styles.kpiTileValue}>{kpis.aiAccuracyPercent}%</span>
      </div>
      <div className={styles.kpiTile}>
        <span className={styles.kpiTileLabel}>Incidents</span>
        <span className={styles.kpiTileValue}>{kpis.activeIncidents}</span>
      </div>
      <div className={styles.kpiTile}>
        <span className={styles.kpiTileLabel}>Resolved</span>
        <span className={styles.kpiTileValue}>{kpis.resolvedRatePercent}%</span>
      </div>
    </div>
  );
};
